...
// Finalization mix - force all bits of a hash block to avalanche
	...
	MEOW_FORCE_INLINE inline uint32_t fmix(uint32_t h)
	{
		h ^= h >> 16;
		h *= 0x85ebca6b;
		h ^= h >> 13;
	...
	MEOW_FORCE_INLINE inline uint64_t fmix(uint64_t k)
	{
		k ^= k >> 33;
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	inline void MurmurHash3_x86_32(void const *key, int const len, uint32_t const seed, void *out)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	inline void MurmurHash3_x86_128(void const *key, int const len, uint32_t const seed, void *out)
	{
		const uint8_t * data = (const uint8_t*)key;
...
////////////////////////////////////////////////////////////////////////////////////////////////
	...
	inline void MurmurHash3_x64_128(void const *key, int const len, uint32_t const seed, void *out)
	{
		const uint8_t * data = (const uint8_t*)key;
		const int nblocks = len / 16;
...
////////////////////////////////////////////////////////////////////////////////////////////////
// wrappers - 32 bit arch

	inline void MurmurHash3_x86(void const *key, int const len, uint32_t const seed, uint32_t *result)
	{
		MurmurHash3_x86_32(key, len, seed, result);
	}

	inline void MurmurHash3_x86(void const *key, int const len, uint32_t const seed, uint64_t *result)
	{
		uint64_t out_128[2];
...
////////////////////////////////////////////////////////////////////////////////////////////////
// wrappers - 64 bit arch

	inline void MurmurHash3_x64(void const *key, int const len, uint32_t const seed, uint32_t *result)
	{
		uint32_t out_128[4];
	...
	inline void MurmurHash3_x64(void const *key, int const len, uint32_t const seed, uint64_t *result)
	{
		uint64_t out_128[2];
		MurmurHash3_x64_128(key, len, seed, &out_128);
		*result = out_128[0];
...
// wrappers - generic
	...
	inline void MurmurHash3(void const *key, int const len, uint32_t const seed, uint32_t *result)
	{
	#if (64 == MEOW_PLATFORM_BITS)
		MurmurHash3_x64(key, len, seed, result);
	#else // 32bit and everything else
		MurmurHash3_x86(key, len, seed, result);
	#endif
	}

	inline void MurmurHash3(void const *key, int const len, uint32_t const seed, uint64_t *result)
	{
	#if (64 == MEOW_PLATFORM_BITS)
		MurmurHash3_x64(key, len, seed, result);
	#else // 32bit and everything else
	...
	inline void MurmurHash3_128(const void *key, int len, uint32_t seed, void *result)
	{
	#if (64 == MEOW_PLATFORM_BITS)
